<?php
    ...
    $sql = "SELECT Time,ClosePrice FROM stockhistory WHERE Symbol='GS' AND Time >= ( CURDATE( ) - INTERVAL 60 DAY ) ORDER BY Time";
	$sql1 = "SELECT Time,ClosePrice FROM ann WHERE Symbol='GS' AND Time <= ( CURDATE( ) + INTERVAL 5 DAY ) ORDER BY Time";
