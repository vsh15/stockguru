<?php
    ...
    $sql = "SELECT Time,ClosePrice FROM stockhistory WHERE Symbol='BAC' AND Time >= ( CURDATE( ) - INTERVAL 60 DAY ) ORDER BY Time";
	$sql1 = "SELECT Time,ClosePrice FROM ann WHERE Symbol='BAC' AND Time <= ( CURDATE( ) + INTERVAL 1 DAY ) ORDER BY Time";
